...
export default class CommonDialog extends Component {
    ...
    render() {
        ...
        return (
            <div className='modal fade' tabIndex="-1" role="dialog" aria-hidden="true" data-backdrop="static" style={{'overflow': 'auto'}}>
                <div className={className} style={dialogStyle}>
                    <div className="modal-content">
                        <div className="modal-header">
                            ...
                            <h3 className="modal-title" id="myModalLabel" style={{wordWrap: 'break-word', display: 'flex', alignItems: 'center'}}>
                                {this.props.title}
                                <div className="text-danger"
                                     style={{fontSize: '12pt'}}>{this.props.info ? this.props.info : null}</div>
                                <div style={{display: 'inline-block', marginLeft: '10px'}}>{this.props.htmlContent ? this.props.htmlContent : null}</div>
                            </h3>
                        </div>
