...
ruleforge.ConditionLeft.prototype.getVariableValue=function(){
	return this.variableValue;
};
ruleforge.ConditionLeft.prototype.getOperator=function(){
	return this.operator;
};
ruleforge.ConditionLeft.prototype.getInputType=function(){
