...
ruleforge.MethodValue.prototype.initMenu = function (actionLibraries) {
...
ruleforge.MethodValue.prototype.setAction = function (data) {
    window._setDirty();
    if (this.action) {
...
ruleforge.MethodValue.prototype.getDisplayContainer = function () {
    var name = "", method = "";
    if (this.action) {
...
ruleforge.MethodValue.prototype.toXml = function () {
...
ruleforge.MethodValue.prototype.getContainer = function () {
