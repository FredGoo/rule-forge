...
export default class ResourceVersionDialogComponent extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        event.eventEmitter.on(event.OPEN_RESOURCE_VERSION_DIALOG, (config) => {
    ...
    handleConfirm() {
        ...
        var selectedRow = this.state.data[this.state.selectedIndex];
    ...
    handleRowClick(rowIndex, rowData) {
